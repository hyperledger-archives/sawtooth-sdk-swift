...
pipeline {
    ...
    stages {
        ...
        stage ('Build Documentation') {
            steps {
                sh 'docker build . -f ci/build-docs -t sawtooth-sdk-swift-docs:$ISOLATION_ID'
                sh 'docker run -v $(pwd):/project/sawtooth-sdk-swift sawtooth-sdk-swift-docs:$ISOLATION_ID'
            }
        }
